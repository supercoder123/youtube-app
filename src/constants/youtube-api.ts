...
export const PLAYLISTS_ITEMS_API_URL = `https://youtube.googleapis.com/youtube/v3/playlistItems?part=snippet%2CcontentDetails&maxResults=25&key=${API_KEY}`;
...
export const VIDEO_DETAILS_API_URL = 'https://www.googleapis.com/youtube/v3/videos?part=statistics,topicDetails,player,contentDetails&key=${API_KEY}'